...
class arkUtilTest(unittest.TestCase):
	...
	def test_getExtension(self):
		self.assertEqual(arkUtil.getExtension('mike.txt'), '.txt')
		self.assertEqual(arkUtil.getExtension('/path/to/file.yolo'), '.yolo')
		self.assertEqual(arkUtil.getExtension('path/to/file'), '')

	def test_normalizeExtension(self):
		self.assertEqual(arkUtil.normalizeExtension('.TXT'), '.txt')
		self.assertEqual(arkUtil.normalizeExtension('png'), '.png')
		self.assertEqual(arkUtil.normalizeExtension('Yolo'), '.yolo')

	def test_removeExtension(self):
		self.assertEqual(arkUtil.removeExtension('mike.txt'), 'mike')
		self.assertEqual(arkUtil.removeExtension('path/to/file.psd'), 'path/to/file')
		self.assertEqual(arkUtil.removeExtension('mike'), 'mike')

	def test_ensureExtension(self):
		self.assertEqual(arkUtil.ensureExtension('Mike.txt', '.txt'), 'Mike.txt')
		self.assertEqual(arkUtil.ensureExtension('Mike', '.txt'), 'Mike.txt')
		self.assertEqual(arkUtil.ensureExtension('Mike.txt', '.mb'), 'Mike.txt.mb')
